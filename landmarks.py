...
class FullBody_LM:
    def __init__(self):
        ...
        self.DrwaingSpec = self.mpDrawing.DrawingSpec((0, 140, 255),
                                                      thickness=1,
                                                      circle_radius=1
                                                      )
...
class Face(FullBody_LM):
    ...
    def Drawing(self, image, imageRGB):
    ...
    def Find_Points(self, image, imageRGB):
        ...
        def Left_Eye():
            ...
            if len(Points) != 0:
                ...
                ROI.append([[130, LeftEyeXL, LeftEyeYL],
        ...
        def Right_Eye():
            ...
            if len(Points) != 0:
                ...
                ROI.append([[463, RightEyeXL, RightEyeYL],
